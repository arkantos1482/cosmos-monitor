...
func writeEconomics(w Writer, d model.Report) {
	...
	w.Hint("KaTeX math (`$$` blocks below) and Mermaid diagram use live values from feemarket REST, CometBFT `block_results`, and `eth_gasPrice`. Payout path is in Overview above.")
