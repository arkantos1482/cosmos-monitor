...
func writeDelegate(w Writer, d model.Report) {
	...
	w.WriteHTML(`<li>Switch to chain <code>290290</code> (PMT). Cosmos id <code>pmt</code> is not an EVM chain id.</li>`)
	...
	w.WriteHTML(`<li>Amount is PMT at <strong>18</strong> decimals. Do not use 6-decimal units.</li>`)
	...
	w.WriteHTML(`<li>If gas estimate fails, the wallet can use limit 500000. A high gas price is still a tiny PMT fee.</li>`)
